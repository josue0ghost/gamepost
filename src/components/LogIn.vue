    ...
    <b-container>
      <div class="row align-items-center">
        <b-col class="col-md-6 col-12 text-center">
          <img alt="GamePost logo" width="100%" height="100%" src="../assets/logo.png" />
        </b-col>
        <b-col class="col-md-6 col-12 text-center">
          <b-card-body class="square-card">                    
            <b-form role="form" @submit.prevent="onSubmit(onSubmit)">
              ...
              <b-form-checkbox class="my-3" v-model="user.rememberMe">Remember me</b-form-checkbox>

              <b-alert v-model="loginerror" variant="danger" dismissible>
                email or password incorrect
              </b-alert>
              <b-button type="submit" class="font-general my-3" block variant="primary">Log In</b-button>
            </b-form>
